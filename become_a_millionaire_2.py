...
for i in range(len(questions)):
    ...
    if answer == true_answers[i]:
        if i == 2:
            unburnable_sum = 300000
        elif i == 6:
            unburnable_sum = 700000
        score += 10000

        if i == len(questions) - 1:
            score += 1000000
            print(f"Поздравляем, вы ответили на все вопросы правильно! Ваш выигрыш: {score + unburnable_sum}")

    else:
        print(f"К сожалению, вы допустили ошибку на вопросе {i + 1}. Ваш выигрыш составляет: {unburnable_sum}")
        break